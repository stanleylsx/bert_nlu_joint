...
class DataManager:
    ...
    def __init__(self, configs, logger):
        ...
        self.domain2id, self.id2domain = self.load_domain_labels()
        self.intent2id, self.id2intent = self.load_intent_labels()
        self.slot2id, self.id2slot = self.load_slot_labels()
